...
export default async function Page() {
    ...
    // вычисляем количество кают
    const cabinsNums = cabins.length;
        ...
        <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
            <div className="col-span-3">
                ...
                <div className="space-y-8">
                    ...
                    <p>
                        Our {cabinsNums} luxury cabins provide a cozy base, but
            ...
            {/* вариант использования Image для адаптивного отображения изображения со статичным файлом изображения */}
            ...
            {/* вариант использования Image для адаптивного отображения изображения с сылкой на изображение.
            aspect-square - соотношение сторон */}
